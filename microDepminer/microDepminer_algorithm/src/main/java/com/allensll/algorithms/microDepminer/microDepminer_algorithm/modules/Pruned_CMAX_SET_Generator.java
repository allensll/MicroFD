package com.allensll.algorithms.microDepminer.microDepminer_algorithm.modules;

import com.allensll.algorithms.microDepminer.microDepminer_helper.modules.Algorithm_Group2_Modul;
...
import com.allensll.algorithms.microDepminer.microDepminer_helper.modules.container.MAX_SET;
...
public class Pruned_CMAX_SET_Generator extends Algorithm_Group2_Modul {
    ...
    public Pruned_CMAX_SET_Generator(int numberOfThreads, List<AgreeSet> agreeSets, int numberOfAttributes, int rhs) {
...
//            }
            exec.execute(new CMAX_SET_JOB(this.rhs));
...
//            }
            exec.execute(new RunnerThreadMaxSet(this.rhs));
            this.awaitExecuter(exec);
        } else {
