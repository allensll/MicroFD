package com.allensll.algorithms.microDFD.microDFD_metanome;
...
public class microDFDMetanome implements FunctionalDependencyAlgorithm,
  ...
  public void setFileInputConfigurationValue(String identifier,
    ...
    if (microDFDMetanome.Identifier.INPUT_FILE.name().equals(identifier)) {
  ...
  public ArrayList<ConfigurationRequirement<?>> getConfigurationRequirements() {
    ...
    configs.add(new ConfigurationRequirementFileInput(microDFDMetanome.Identifier.INPUT_FILE.name()));
    return configs;
  }
